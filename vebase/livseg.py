...
def seg_3dnp(liver,segs,stats,dist_map_final_liver_vol,slices_n): #args are liver maskes, porta masks, stats - skelet3d, dist_map_final... parc. segments, slices_n = number of slices in 3darray example: ircad1.7 got 151 slices
    id_ = []
    for i in range(0, (len(stats))):
        try:
            id_.append(stats[i+1]["nodeIdA"])
